...
/// 
/// </summary>
public class TrainRightLevelController : MonoBehaviour {
    ...
    void Start() {
        ...
        //get completiontime
        completionTime = GuiController.completionWindowTime / 1000.0f;
    ...
    IEnumerator InterTrial() {
        ...
        float countDownTime = GuiController.interTrialTime / 1000.0f;
    ...
    IEnumerator Timeout() {
        ...
        while (true) {
            ...
            if (elapsedTime > completionTime) {
                ...
                //delay for timeout
                float countDownTime = GuiController.timoutTime / 1000.0f;
                while (countDownTime > 0) {
